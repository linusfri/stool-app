{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/linus/Projects/js/stool-app";
devenv_dotfile = "/home/linus/Projects/js/stool-app/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-5219c6d";
...
hostname = "nixos";
username = "linus";
git_root = "/home/linus/Projects/js/stool-app";
